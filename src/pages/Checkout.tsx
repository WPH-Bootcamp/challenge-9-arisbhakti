...
export default function Checkout() {
  return (
    <main className="w-full px-4 md:px-30 md:mt-32 pt-4 md:pt-0 mt-16 flex flex-col gap-4  text-neutral-950  md:flex-row md:gap-5 md:items-start ">
      {/* left side */}
      <div className="flex flex-col gap-4 flex-1">
        {/* Delviery Address */}
        <div className="flex flex-col gap-4 p-4 rounded-3xl shadow-sm ">
          {/* Header & Text */}
          <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-row gap-2 items-center">
              ...
              />
              <span className="text-base leading-7.5 font-extrabold ">
                Delivery Address
              </span>
            </div>
            {/* Address */}
          ...
          {/* button */}
          <button className="h-9 w-30  rounded-full ring-1 ring-inset ring-neutral-300 flex items-center justify-center font-bold text-sm leading-7 -tracking-[0.02em]">
            Change
          </button>
        </div>
        {/* Cart Summary */}
        <div className="flex flex-col gap-3 p-4 rounded-3xl shadow-sm">
          {/* Header & Button */}
          <div className="flex flex-row justify-between">
            ...
            <button className="h-9 w-26.5  rounded-full ring-1 ring-inset ring-neutral-300 flex items-center justify-center font-bold text-sm leading-7 -tracking-[0.02em]">
              Add Item
            </button>
          </div>
          {/* Item List */}
      ...
      <div className="flex flex-col gap-4 p-4 rounded-3xl shadow-sm w-full flex-1">
        {/* Payment Method div */}
        <div className="flex flex-col gap-3">
          <h1 className="font-bold text-base leading-7.5">Payment Method</h1>
          {/* banks */}
          <div className="flex flex-row justify-between">
            {/* bank image and name */}
            <div className="flex flex-row gap-2 items-center ">
              ...
              {/* bank name */}
              <span className="font-bold text-sm leading-7.5 -tracking-[0.02em] md:text-base md:leading-7.5 md:-tracking-[0.03em]">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="font-extrabold text-base leading-7.5 ">
              Payment Summary
            </h1>
            <div className="flex flex-row justify-between">
              <span className="text-sm leading-7 font-medium">
              ...
              <span className="font-bold text-sm leading-7 -tracking-[0.02em]">
                Rp100.000
              </span>
            </div>
            <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-row justify-between">
              <span className="text-base leading-7.5 font-normal -tracking-[0.02em] ">
                Total
              </span>
              <span className="font-extrabold text-base leading-7.5">
                Rp100.000
              </span>
            </div>
            <button className="h-11 md:h-12 w-full md:w-60 rounded-[100px] bg-primary-100 text-white font-bold text-base leading-7.5 -tracking-[0.02em] items-center justify-center text-center md:text-[16px] md:leading-7.5 md:-tracking-[0.02em]">
              Buy
            </button>
          </div>
        </div>

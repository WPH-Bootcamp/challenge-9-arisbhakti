          ...
          <div className="flex flex-col gap-3 shadow-lg p-4 rounded-3xl">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center">
              ...
              <button
                ...
                className="h-11 md:h-12 w-full md:w-60 rounded-[100px] bg-primary-100 text-white font-bold text-[14px] leading-7 -tracking-[0.02em] md:text-[16px] md:leading-7.5 md:-tracking-[0.02em]"
              >
                Give Review
              </button>
            </div>
